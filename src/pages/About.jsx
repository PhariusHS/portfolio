        ...
        <article className="flex flex-col mx-auto md:items-left items-center md:flex-col md:mx-10 order-2 md:order-1 mt-8 md:pr-16 ">
          ...
          <div className="flex flex-col mx-auto md:items-left items-right aboutLate mt-6">
            <p className="md:text-left text-center font-bold text-sm md:max-w-lg max-w-xl md:pr-16 dark:text-seagull-50">
              ...
              {/* About me 1 */}
              {language === "english"
                ? "Hello! I am Luca Ponteprimo, a full-stack web developer and programming technician. I am a young enthusiast for challenges, teamwork, and the exciting process of project development."
                : " ¡Hola! Soy Luca Ponteprimo, un desarrollador web full-stack, técnico en programación y un joven entusiasta de los desafíos, el trabajo en equipo y el emocionante proceso de desarrollo de proyectos."}
            </p>
