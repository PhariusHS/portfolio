...
function NavBar() {
  ...
  const content = <>
      <div className="lg:hidden block absolute top-14 w-full left-0 right-0 bg-seagull-400 transition">
        <ul className="text-center text-xl px-20 pt-4 pb-32">
    ...
    <nav className="w-full">
      <div className="h-10vh w-full flex justify-between z-50 text lg:py-2 pl-5 py-3">
        <div className="flex items-center flex-1 ">
          <span className="text-2xl font-bold">Luca Ponteprimo</span>
        </div>
        <div className="lg:flex md:flex lg: flex-1 items-center justify-end font-normal hidden">
          <div className="flex-10">
            <ul className="flex gap-8 mx-10 text-[18px]">
              <Link spy={true} smooth={true} to="about">
                <li className=" flex justify-center items-center px-1 mx-4 hover:bg-seagull-700 hover:cursor-pointer transition border-b-2 border-slate-800 hover:rounded-lg  hover:border-pizazz-950 hover:text-seagull-400">
                  ABOUT
                </li>
              </Link>
              <Link spy={true} smooth={true} to="project">
